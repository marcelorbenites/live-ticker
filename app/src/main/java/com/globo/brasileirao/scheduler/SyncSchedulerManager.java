...
public class SyncSchedulerManager implements MatchSyncScheduler, MatchLiveTickerScheduler {
    ...
    public static final String TAG_SYNC_MATCH_LIVE_TICKER = "com.globo.sync.tag.SYNC_MATCH_LIVE_TICKER";
    ...
    @Override public void syncMatches(long interval) {
        gcmNetworkManager.schedule(gcmTaskFactory.createPeriodicTask(TAG_SYNC_MATCHES, interval, serviceClass, null));
    }
    ...
    @Override public void syncMatchLiveTicker(int matchId, long interval) {
        ...
        gcmNetworkManager.schedule(gcmTaskFactory.createPeriodicTask(TAG_SYNC_MATCH_LIVE_TICKER, interval, serviceClass, bundle));
    }
