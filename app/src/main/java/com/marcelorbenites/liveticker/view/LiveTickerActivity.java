...
import com.marcelorbenites.liveticker.view.adapter.LiveTickerEntriesAdapter;
...
public class LiveTickerActivity extends BaseActivity {
  ...
  public static final String EXTRA_MATCH = "com.marcelorbenites.liveticker.intent.extra.MATCH";
  ...
  public void setMatch(Match match) {
    ...
    imageLoader.loadFromNetwork(homeTeamIcon, match.getHomeTeam()
        .getIconUrl(), teamIconWidth, teamIconHeight, R.mipmap.ic_launcher);
    imageLoader.loadFromNetwork(awayTeamIcon, match.getAwayTeam()
        .getIconUrl(), teamIconWidth, teamIconHeight, R.mipmap.ic_launcher);
