...
public interface ImageLoader {
  ...
  /**
   * Load image from network into image view resizing the image with provided width and height in
   * pixels.
   *
   ...
   */
  void loadFromNetwork(ImageView imageView, String url, int width, int height,
