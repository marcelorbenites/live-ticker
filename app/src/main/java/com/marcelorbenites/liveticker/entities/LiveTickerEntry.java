...
@JsonIgnoreProperties(ignoreUnknown = true) public class LiveTickerEntry {
  ...
  @JsonCreator
  public LiveTickerEntry(@JsonProperty("matchId") int matchId, @JsonProperty("time") int matchTime,
