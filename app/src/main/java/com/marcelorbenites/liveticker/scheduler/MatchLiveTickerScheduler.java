...
public interface MatchLiveTickerScheduler {
  ...
  /**
   * Schedule match live ticker synchronization to be performed periodically using an interval in
   * background.
   * Any subsequent calls to this method will update the interval and the match id of the existing
   * schedule.
   *
